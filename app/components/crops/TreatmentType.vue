<template>
  <div>
    ...
    <div v-if="loading" class="flex items-center justify-center py-12">
      ...
      <span class="ml-3 text-gray-600">Loading treatment types...</span>
    </div>
            ...
            <tr v-for="item in treatments" :key="item.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span :class="[
                  ...
                  normalizeStatus(item.status) === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                ]">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                ...
                <button @click="item.uuid && deleteItem(item.uuid)" :disabled="!item.uuid" class="text-red-600 hover:text-red-900 disabled:cursor-not-allowed disabled:opacity-50">
            ...
            <form @submit.prevent="submitForm" class="p-4 space-y-4">
              ...
              <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                ...
                <Button type="submit" :disabled="submitting">
                  ...
                  <span v-else>{{ isEditing ? 'Update' : 'Add' }} Treatment Type</span>
                </Button>
              </div>
            </form>
          </div>
...
const normalizeStatus = (status: Treatment['status']) =>
