    ...
    <section class="bg-gradient-to-br from-green-50 via-white to-emerald-50 py-20 px-4">
      <div class="max-w-6xl mx-auto text-center">
        ...
        <p class="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
          Whether you grow maize in Kenya, cocoa in Ghana, or keep sheep in South Africa — Farmconsul helps you record everything, track your workers, and never forget a harvest. Even without airtime or Wi-Fi.
        </p>
